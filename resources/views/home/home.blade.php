...
<meta name="theme-color" content="#563d7c">
  ...
  <body>
        ...
        <div class="position-relative overflow-hidden p-3 p-md-5 m-md-3 text-center bg-dark" id="bg">
            <div class="col-md-5 p-lg-5 mx-auto my-5">
                <h1 class="display-4 font-weight-normal text-white">Nura Dekorasi</h1>
                <p class="lead font-weight-normal text-white">Percayakan semua kebutuhan dekorasi pada kami</p>
                <a class="btn btn-outline-warning" href="#">Daftar Sekarang</a>
            </div>
        </div>
        ...
        <div class="bg-light mr-md-3 pt-3 px-3 pt-md-5 px-md-5 text-center overflow-hidden">
            ...
            <div class="bg-dark shadow-sm mx-auto" style="width: 80%; height: 300px; border-radius: 21px 21px 0 0;">
                <img src="/image/bg.jpg" alt="" width="200">
            </div>
        </div>
        </div>
