...
<html lang="en">
    <head>
        ...
        <title>@yield('title') - Nura Dekorasi</title>
    ...
    <body class="sb-nav-fixed">
        <nav class="sb-topnav navbar navbar-expand navbar-dark bg-dark">
            <a class="navbar-brand" href="/admin/dashboard">Nura Dekorasi</a>
                        ...
                        <div class="nav">
                            ...
                            <div class="collapse" id="collapseLayouts" aria-labelledby="headingOne" data-parent="#sidenavAccordion">
                                <nav class="sb-sidenav-menu-nested nav">
                                    <a class="nav-link" href="/admin/daftar_barang">Daftar Barang</a>
                                    <a class="nav-link" href="/admin/daftar_harga">Harga Barang</a>
                                </nav>
                            </div>
                            ...
                            <div class="collapse" id="collapseLayouts1" aria-labelledby="headingOne" data-parent="#sidenavAccordion">
                                <nav class="sb-sidenav-menu-nested nav">
                                    <a class="nav-link" href="/admin/form_transaksi">Transaksi</a>
                                    <!-- <a class="nav-link" href="#">Data Pembelian</a> -->
                                    <a class="nav-link" href="/admin/data_transaksi">Data Transaksi</a>
                                </nav>
                            </div>
                            ...
                            <div class="collapse" id="collapseLayouts2" aria-labelledby="headingOne" data-parent="#sidenavAccordion">
                                <nav class="sb-sidenav-menu-nested nav">
                                    <a class="nav-link" href="/admin/form_gallery">Tambah Gallery</a>
                                    <a class="nav-link" href="/admin/details_gallery">Details Gallery</a>
                                </nav>
                            </div>
        ...
        @yield('chart')
        <!-- Chart Menggunakan jquery dan Chart.js jadi harus dibawah keduanya -->
    </body>
   ...
   <div class="modal fade" id="ganti_password" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
                <div class="modal-dialog">
                  <div class="modal-content">
                      ...
                      <!-- ============ Modal Body =========== -->
                          <form method="post" action="/admin/ganti_password">
                            @csrf
